package com.flightprovidera.config;
...
public class SoapConfig {
  ...
  @Bean(name = "flight-provider-a")
  public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema flightSchema) {
    DefaultWsdl11Definition wsdl11Definition = new DefaultWsdl11Definition();
    wsdl11Definition.setPortTypeName("FlightProviderAPort");
    wsdl11Definition.setLocationUri("/ws");
    wsdl11Definition.setTargetNamespace("http://flightprovidera.com");
